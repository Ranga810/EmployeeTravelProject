...
public class BookingRowMapper implements RowMapper<BookingDetails> {
	...
	public BookingDetails mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		int bookingId=rs.getInt("booking_id");
		 ...
		 BookingDetails bookingDetails= new BookingDetails(bookingId, requestTravelId, onboardingDate, onboardingPlace, destination, destinationDate, hotelName, hotelAddress, checkInTime, checkOutTime, contactNumber);
